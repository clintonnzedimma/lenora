                    ...
                    <div class="modal-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                <b>Enter Assignment Code</b><br>
                                                <input type="text" name="keyCode" class="form-control" placeholder="e.g HW-1234" value="<?php if(isset($_POST['keyCode'])) echo $_POST['keyCode']; ?>">
                                            </div>


       
                                            <button class="btn_1 full_width text-center" type="submit" name="submit">View</button>
