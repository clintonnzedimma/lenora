                    ...
                    <div class="modal-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                <b>Enter Classroom Code</b><br>
                                                <input type="text" name="id" class="form-control" placeholder="e.g LH1234" value="<?php if(isset($_POST['id'])) echo $_POST['id']; ?>">
                                            </div>


       
                                            <button class="btn_1 full_width text-center" type="submit" name="submit">Join</button>
