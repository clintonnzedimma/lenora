            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                 ...
                 <?php 
                    ...
                    <tr>
                                        <th scope="row"><?php echo $student_assignment['keyCode'] ?></th>
                                        <td><?php echo date("h:ia d M Y", strtotime($student_assignment['createdAt'])) ?></td>
                                        <td><a href="/student-dashboard/assignment/<?php echo $student_assignment['keyCode'] ?>" class="status_btn" target="_blank">Open</a></td>
                                    </tr>
                <?php }?>
