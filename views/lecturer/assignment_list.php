            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                 ...
                 <?php foreach($assignments as $assignment) {?>
                    <tr>
                                        <th scope="row"><?php echo $assignment['keyCode'] ?></th>
                                        <td><?php echo $assignment['title'] ?></td>
                                        <td><?php echo date("h:ia d M Y", strtotime($assignment['createdAt'])) ?></td>
                                        <td><a href="/lecturer-dashboard/assignment/<?php echo $assignment['keyCode'] ?>" class="status_btn">Open</a></td>
                                    </tr>
                <?php }?>
