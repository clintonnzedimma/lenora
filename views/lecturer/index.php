                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="quick_activity_wrap">
                                        ...
                                        <a href="/lecturer-dashboard/start-class">
                                            <div class="single_quick_activity">

                                                <h2 style="color:white">Start a Class</h2>
                                               
                                            </div>
                                        </a>

                                        <a href="/lecturer-dashboard/classrooms">
                                            <div class="single_quick_activity">
                                                <h2 style="color:white">My Class Rooms</h2>

                                            </div>
                                        </a>

                                        <a href="/lecturer-dashboard/create-assignment">
                                            <div class="single_quick_activity">
                                                <h2 style="color:white">Create Assignment</h2>
                                                <!-- <h3>$ <span class="counter">79,000</span> </h3>
                                                <p>Saved 25%</p> -->
                                            </div>
                                        </a>

                                        <a href="/lecturer-dashboard/publish-note">
                                            <div class="single_quick_activity">
                                                <h2 style="color:white">Publish Note</h2>
                                   
                                            </div>
                                        </a>

                                        <a href="/lecturer-dashboard/all-assignments">
                                            <div class="single_quick_activity">
