                            ...
                            <div class="row">
                                ...
                                <form method="POST">    
                                    <div class="form-group">
                                        Submitted By : <?php  echo $student_assignment['studentName']; ?><br>
                                        <?php if($student_assignment['grade'] != NULL) {?>
                                            <p><strong style="color:#ffaf47">GRADE : <?php echo $student_assignment['grade'] ?></strong></p>
                                        <?php }?>
                                                    <b>Answer</b><br>
                                                   <?php  echo $student_assignment['body']; ?>
                                    </div>
                                    ...
                                    <div> 
                                        <form method="POST">
                                            <div class="form-group">
                                                <b>Score</b><br>
                                                <input type="text" name="grade" class="form-control" placeholder="e.g 6/10" value="<?php 
                                                      if($student_assignment['grade']){
                                            ...
                                            <div class="form-group">
                                                <b>Remark</b><br>
                                                <input type="text" name="remark" class="form-control" placeholder="E.g Very Good" value="<?php 
                                                      if($student_assignment['remark']){
                                                         echo $student_assignment['remark'];
                                                     } ?>">
                                            </div>
                                         <button class="btn_1 full_width text-center" type="submit" name="submit" >Submit</button>
                                        </form>
