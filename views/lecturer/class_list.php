...
<head>
    ...
    <title>My ClassRooms - Lecturer Dashboard</title>
                ...
                <div class="col-lg-12">
                 ...
                 <?php foreach($classrooms as $c) {?>
                    <tr>
                                        ...
                                        <td><?php echo date("h:ia d M Y", strtotime($c['createdAt'])) ?></td>
                                        <td><a href="/lecturer-dashboard/class/<?php echo $c['id'] ?>" class="status_btn">Open</a></td>
                                    </tr>
                <?php }?>
