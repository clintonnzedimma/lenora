                ...
                <div class="col-lg-12">
                    ...
                    <div class="modal-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                <b>Type questions</b><br>
                                                <textarea id="summernote" name="body"><?php if(isset($_POST['body'])) echo $_POST['body']; ?></textarea>
                                            </div>
                    
                                            <div class="form-group">
                                                <b> Stop accepting submissions on</b> <br>
                                                <div id="datepicker" class="input-group date" data-date-format="mm-dd-yyyy">
    <input class="form-control" type="datetime-local" name="expiresOn"/>
