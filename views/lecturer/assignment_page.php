...
<head>
    ...
    <title><?php echo $assignment['keyCode'] ?> -  Lecturer Dashboard</title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                 ...
                 <?php 
                    ...
                    <tr>
                                        <th scope="row"><?php echo $student_assignment['studentName'] ?></th>
                                        <td><?php echo date("h:ia d M Y", strtotime($student_assignment['createdAt'])) ?></td>
                                        <td><a href="/lecturer-dashboard/assignment/submissions/<?php echo $student_assignment['id'] ?>" class="status_btn" target="_blank">Open</a></td>
                                    </tr>
                <?php }?>
