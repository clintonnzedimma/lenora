                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="quick_activity_wrap">
                                        ...
                                        <a href="/lecturer-dashboard/create-assingment">
                                            <div class="single_quick_activity">
                                        ...
                                        <a href="/lecturer-dashboard/classrooms">
                                            <div class="single_quick_activity">
                                                <h2 style="color:white">My Classrooms</h2>
                                   
                                            </div>
                                        </a>

                                        <a href="/lecturer-dashboard/submitted-assingments">
                                            <div class="single_quick_activity">
                                                <h2 style="color:white"> Student Assignments</h2>
                                            </div>
                                        </a>
                                    </div>
                                </div>
